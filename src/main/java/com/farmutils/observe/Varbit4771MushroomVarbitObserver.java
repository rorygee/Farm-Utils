...
/** Mushroom patch observer for FARMING_TRANSMIT_A (varbit 4771) at Canifis. */
@Slf4j
@Singleton
public class Varbit4771MushroomVarbitObserver
{
    ...
    @Inject
    public Varbit4771MushroomVarbitObserver(final Client client, final InferenceEngine inferenceEngine)
    {
        this.client = client;
    ...
    private void handleVarbitValue(final PatchId patch, final int raw)
    {
        ...
        final DecodedPatchState cur = StandardMushroomSlotDecoder.decode(raw);
    ...
    static
    {
        REGION_ID_TO_PATCH.put(13622, PatchId.SPECIAL_MUSHROOM);
        REGION_ID_TO_PATCH.put(13878, PatchId.SPECIAL_MUSHROOM);
    }
}

...
/** Coral nursery observer for FARMING_TRANSMIT_A (varbit 4771) at Great Conch. */
@Slf4j
@Singleton
public class Varbit4771CoralVarbitObserver
{
    ...
    @Inject
    public Varbit4771CoralVarbitObserver(final Client client, final InferenceEngine inferenceEngine)
    {
        this.client = client;
    ...
    static
    {
        PatchId id = PatchId.SPECIAL_CORAL_NURSERY_PLOT_1;
        int[] regions = new int[]
        {

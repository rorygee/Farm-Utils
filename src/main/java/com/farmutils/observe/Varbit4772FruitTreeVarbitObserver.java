...
/** Fruit tree patch observer for FARMING_TRANSMIT_B (varbit 4772). */
@Slf4j
@Singleton
public class Varbit4772FruitTreeVarbitObserver
{
    ...
    @Inject
    public Varbit4772FruitTreeVarbitObserver(final Client client, final InferenceEngine inferenceEngine)
    {
        this.client = client;
    ...
    {
        // Gnome Stronghold
        REGION_ID_TO_PATCH.put(9781, PatchId.FRUIT_TREE_GNOME_STRONGHOLD);
        REGION_ID_TO_PATCH.put(9782, PatchId.FRUIT_TREE_GNOME_STRONGHOLD);
        REGION_ID_TO_PATCH.put(9526, PatchId.FRUIT_TREE_GNOME_STRONGHOLD);
        REGION_ID_TO_PATCH.put(9525, PatchId.FRUIT_TREE_GNOME_STRONGHOLD);

        // Kastori (+ adjacent)
        REGION_ID_TO_PATCH.put(5423, PatchId.FRUIT_TREE_KASTORI);
        REGION_ID_TO_PATCH.put(5167, PatchId.FRUIT_TREE_KASTORI);
        REGION_ID_TO_PATCH.put(5424, PatchId.FRUIT_TREE_KASTORI);
    }
}

...
/**
 * Farming Guild allotment patch observer for FARMING_TRANSMIT_D (varbit 4774).
 *
 * <p>RuneLite Time Tracking uses this slot for the Farming Guild south allotment plot.</p>
 */
@Slf4j
@Singleton
public class Varbit4774AllotmentVarbitObserver
{
    ...
    private static final PatchId PATCH_ID = PatchId.ALLOTMENT_FARMING_GUILD_PLOT_2;
    ...
    @Inject
    public Varbit4774AllotmentVarbitObserver(final Client client, final InferenceEngine inferenceEngine)
    {
        this.client = client;

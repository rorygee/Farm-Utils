...
/** Spirit tree observer for FARMING_TRANSMIT_B (varbit 4772). */
@Slf4j
@Singleton
public class Varbit4772SpiritTreeVarbitObserver
{
    ...
    @Inject
    public Varbit4772SpiritTreeVarbitObserver(final Client client, final InferenceEngine inferenceEngine)
    {
        this.client = client;
    ...
    {
        // Brimhaven
        REGION_ID_TO_PATCH.put(11058, PatchId.SPIRIT_TREE_BRIMHAVEN);
        REGION_ID_TO_PATCH.put(11057, PatchId.SPIRIT_TREE_BRIMHAVEN);

        // Etceteria
        REGION_ID_TO_PATCH.put(10300, PatchId.SPIRIT_TREE_ETCETERIA);
    }
}

...
/** Quest patch observer for the White Knights' Castle enriched snapdragon (varbit 10781). */
@Slf4j
@Singleton
public class Varbit10781EnrichedSnapdragonVarbitObserver
{
    static final int VARBIT_ID = 10781;

    private static final int REGION_ID = 11828;
    private static final int PLANE = 3;
    private static final WorldPoint ANCHOR = new WorldPoint(2962, 3338, 3);
    ...
    @Inject
    public Varbit10781EnrichedSnapdragonVarbitObserver(final Client client, final InferenceEngine inferenceEngine)
    {
        this.client = client;
    ...
    public void onGameTick()
    {
        ...
        handleVarbitValue(PatchId.QUEST_ENRICHED_SNAPDRAGON, raw);
    }

    private void handleVarbitValue(final PatchId patch, final int raw)
    {
        final Instant now = Instant.now();
        final DecodedPatchState cur = QuestEnrichedSnapdragonSlotDecoder.decode(raw);
        ...
        // NPC harvest/quest completion: crop -> empty.

...
/** Hardwood tree patch observer for FARMING_TRANSMIT_C (varbit 4773) on Fossil Island. */
@Slf4j
@Singleton
public class Varbit4773HardwoodVarbitObserver
{
    ...
    private static final PatchId PATCH_ID = PatchId.SPECIAL_TREE_HARDWOOD_FOSSIL_ISLAND_PLOT_3;
    ...
    @Inject
    public Varbit4773HardwoodVarbitObserver(final Client client, final InferenceEngine inferenceEngine)
    {
        this.client = client;

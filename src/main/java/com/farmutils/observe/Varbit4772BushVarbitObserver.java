...
/** Bush patch observer for FARMING_TRANSMIT_B (varbit 4772) at Farming Guild. */
@Slf4j
@Singleton
public class Varbit4772BushVarbitObserver
{
    ...
    private static final PatchId PATCH_ID = PatchId.BUSH_FARMING_GUILD;
    ...
    @Inject
    public Varbit4772BushVarbitObserver(final Client client, final InferenceEngine inferenceEngine)
    {
        this.client = client;

...
/** Fruit tree patch observer for FARMING_TRANSMIT_A (varbit 4771). */
@Slf4j
@Singleton
public class Varbit4771FruitTreeVarbitObserver
{
    ...
    @Inject
    public Varbit4771FruitTreeVarbitObserver(final Client client, final InferenceEngine inferenceEngine)
    {
        this.client = client;
    ...
    {
        // Brimhaven
        REGION_ID_TO_PATCH.put(11058, PatchId.FRUIT_TREE_BRIMHAVEN);
        REGION_ID_TO_PATCH.put(11057, PatchId.FRUIT_TREE_BRIMHAVEN);

        // Catherby
        REGION_ID_TO_PATCH.put(11317, PatchId.FRUIT_TREE_CATHERBY);

        // Tree Gnome Village
        REGION_ID_TO_PATCH.put(9777, PatchId.FRUIT_TREE_GNOME_VILLAGE);
        REGION_ID_TO_PATCH.put(10033, PatchId.FRUIT_TREE_GNOME_VILLAGE);

        // Lletya
        REGION_ID_TO_PATCH.put(9265, PatchId.FRUIT_TREE_LLETYA);
        REGION_ID_TO_PATCH.put(11103, PatchId.FRUIT_TREE_LLETYA);
    }
}

...
/** Seaweed patch observer for FARMING_TRANSMIT_B (varbit 4772) at Seaweed (Underwater). */
@Slf4j
@Singleton
public class Varbit4772SeaweedVarbitObserver
{
    ...
    @Inject
    public Varbit4772SeaweedVarbitObserver(final Client client, final InferenceEngine inferenceEngine)
    {
        this.client = client;
    ...
    static
    {
        REGION_ID_TO_PATCH.put(15008, PatchId.SPECIAL_SEAWEED_PLOT_2);
    }
}

...
/** Coral nursery observer for FARMING_TRANSMIT_B (varbit 4772) at Great Conch. */
@Slf4j
@Singleton
public class Varbit4772CoralVarbitObserver
{
    ...
    @Inject
    public Varbit4772CoralVarbitObserver(final Client client, final InferenceEngine inferenceEngine)
    {
        this.client = client;
    ...
    private void handleVarbitValue(final PatchId patch, final int raw)
    {
        ...
        final DecodedPatchState cur = StandardCoralSlotDecoder.decode(raw);
    ...
    static
    {
        PatchId id = PatchId.SPECIAL_CORAL_NURSERY_PLOT_2;
        int[] regions = new int[]
        {

...
/** Redwood patch observer for FARMING_TRANSMIT_I (varbit 7907) at Farming Guild. */
@Slf4j
@Singleton
public class Varbit7907RedwoodVarbitObserver
{
    static final int VARBIT_ID = 7907;
    ...
    private static final PatchId PATCH_ID = PatchId.SPECIAL_TREE_REDWOOD_FARMING_GUILD;
    ...
    @Inject
    public Varbit7907RedwoodVarbitObserver(final Client client, final InferenceEngine inferenceEngine)
    {
        this.client = client;
    ...
    private void handleVarbitValue(final int raw)
    {
        ...
        final DecodedPatchState cur = StandardRedwoodSlotDecoder.decode(raw);

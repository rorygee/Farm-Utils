...
/** Standard tree patch observer for FARMING_TRANSMIT_G (varbit 7905) at Farming Guild. */
@Slf4j
@Singleton
public class Varbit7905TreeVarbitObserver
{
    static final int VARBIT_ID = 7905;
    ...
    private static final PatchId PATCH_ID = PatchId.TREE_FARMING_GUILD;
    ...
    @Inject
    public Varbit7905TreeVarbitObserver(final Client client, final InferenceEngine inferenceEngine)
    {
        this.client = client;

...
/**
 * Farming Guild allotment patch observer for FARMING_TRANSMIT_C (varbit 4773).
 *
 * <p>RuneLite Time Tracking uses this slot for the Farming Guild north allotment plot.</p>
 */
@Slf4j
@Singleton
public class Varbit4773AllotmentVarbitObserver
{
    ...
    private static final PatchId PATCH_ID = PatchId.ALLOTMENT_FARMING_GUILD_PLOT_1;
    ...
    @Inject
    public Varbit4773AllotmentVarbitObserver(final Client client, final InferenceEngine inferenceEngine)
    {
        this.client = client;

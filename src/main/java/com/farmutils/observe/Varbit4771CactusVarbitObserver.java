...
/** Cactus patch observer for FARMING_TRANSMIT_A (varbit 4771) at Al Kharid. */
@Slf4j
@Singleton
public class Varbit4771CactusVarbitObserver
{
    ...
    @Inject
    public Varbit4771CactusVarbitObserver(final Client client, final InferenceEngine inferenceEngine)
    {
        this.client = client;
    ...
    static
    {
        // Al Kharid cactus patch (+ adjacent regions)
        REGION_ID_TO_PATCH.put(13106, PatchId.CACTUS_AL_KHARID);
        REGION_ID_TO_PATCH.put(13362, PatchId.CACTUS_AL_KHARID);
        REGION_ID_TO_PATCH.put(13105, PatchId.CACTUS_AL_KHARID);
    }
}

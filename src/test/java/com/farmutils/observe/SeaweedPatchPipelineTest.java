...
public class SeaweedPatchPipelineTest
{
    @Test
    public void seaweedDecodesAndFeedsInference()
    {
        assertEquals(PatchId.SPECIAL_SEAWEED_PLOT_1, Varbit4771SeaweedVarbitObserver.patchForRegionId(15008));
        assertEquals(PatchId.SPECIAL_SEAWEED_PLOT_2, Varbit4772SeaweedVarbitObserver.patchForRegionId(15008));

        // Seaweed stage 1
        DecodedPatchState stage1 = StandardSeaweedSlotDecoder.decode(4);
        ...
        assertEquals(Integer.valueOf(ItemID.GIANT_SEAWEED), stage1.getCropItemIdOrNull());
        ...
        PatchId patch = PatchId.SPECIAL_SEAWEED_PLOT_1;
